...
return [
    ...
    'listPage' => [
        ...
        'columns' => [
            ...
            ['field' => 't_name', 'label' => '標籤名稱', 'type' => 'text', 'width' => 400],
    ...
    'detailPage' => [
        [
            'sheetTitle' => '資料設定',
            'items' => [
                ['type' => 'text', 'field' => 't_name', 'label' => '標籤名稱', 'required' => true],
        ...
        [
            'sheetTitle' => 'SEO設定',
            'items' => [
                ['type' => 'text', 'field' => 't_slug', 'label' => '網址別名 (slug)', 'note' => '留空則自動從標題產生'],
                ['type' => 'text', 'field' => 't_seo_title', 'label' => 'SEO 標題', 'note' => '建議長度：50-60 字元'],
                ['type' => 'textarea', 'field' => 't_description', 'label' => 'SEO 描述', 'rows' => 4, 'note' => '建議長度：150-160 字元'],
            ],
        ],
    ],
];
